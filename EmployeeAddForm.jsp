...
<script src='/Employee-Expert/js/EmployeeAddForm.js'></script>
<h2> Employee(Add Module)</h2>
<tm:FormID/>
<form method='post' action='/Employee-Expert/AddEmployee.jsp' onsubmit='return validateForm(this)'>
<table>
<tr>
<td>Name</td>
...
<form id='cancelAdditionForm' action='/Employee-Expert/Employees.jsp'>
</form>
